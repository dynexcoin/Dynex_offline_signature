...
```
curl -X POST -i -H 'Accept: application/json' -d '{"method":"sendrawtransaction", "params": {"tx_as_hex":"<TX_AS_HEX>"},"jsonrpc": "2.0", "id":"1"}' http://node.dynexcoin.org:18333/json_rpc 
``` 
